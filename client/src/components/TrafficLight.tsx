...
export function TrafficLight({ activeLight, countdown }: TrafficLightProps) {
  return (
    <div className="bg-zinc-950 p-6 rounded-3xl border-4 border-zinc-800 shadow-2xl flex flex-col gap-6 w-32 items-center relative overflow-hidden">
      ...
      <div className="relative">
        <motion.div
          ...
          className="w-20 h-20 rounded-full bg-red-500 border-4 border-zinc-900"
        />
      </div>
        ...
        <motion.div
          animate={{
            ...
            boxShadow: activeLight === "yellow" 
              ? "0 0 40px 10px rgba(234, 179, 8, 0.6)" 
              : "none"
          }}
          className="w-20 h-20 rounded-full bg-yellow-500 border-4 border-zinc-900"
        />
      </div>
      ...
      <div className="relative flex items-center justify-center">
        <motion.div
          ...
          className="w-20 h-20 rounded-full bg-green-500 border-4 border-zinc-900"
        />
        {activeLight === "green" && countdown !== null && (
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            <span className="text-3xl font-bold font-mono text-white/90 drop-shadow-md">
              {countdown}
            </span>
          </div>
        )}
